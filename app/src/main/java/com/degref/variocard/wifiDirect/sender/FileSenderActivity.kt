...
import com.degref.variocard.BaseActivity
import com.degref.variocard.DeviceAdapter
import com.degref.variocard.DirectActionListener
import com.degref.variocard.DirectBroadcastReceiver
import com.degref.variocard.OnItemClickListener
import com.degref.variocard.R
import com.degref.variocard.wifiDirect.models.ViewState
import com.degref.variocard.wifiDirect.utils.WifiP2pUtils
...
class FileSenderActivity : BaseActivity() {
    ...
    private val directActionListener = object : DirectActionListener {
        ...
        override fun onConnectionInfoAvailable(wifiP2pInfo: WifiP2pInfo) {
            ...
            stringBuilder.append(if (wifiP2pInfo.isGroupOwner) "It's the group leader" else "Not a group owner")
            stringBuilder.append("\n")
